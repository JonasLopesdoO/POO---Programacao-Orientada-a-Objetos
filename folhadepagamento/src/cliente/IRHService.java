...
public interface IRHService{
     ...
     * O salario dos classes A, B, C, D, E é respectivamente 3000, 5000, 7000, 9000 e 1000 reais.
     * 
     * STA: O "nível" é um int entre 1 e 30. O salario é calculado como 1000 + 100 * nivel;
     *  
